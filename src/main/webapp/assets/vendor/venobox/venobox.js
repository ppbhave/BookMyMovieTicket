...
(function($){
    ...
    var autoplay, bgcolor, blockleft, blocknum, blockshare, blocktitle, border, core, container, content, dest, extraCss,
        ...
        overlayColor, overlay, title, thisgall, thenext, theprev, nextok, prevok, preload()er, $preload()er, navigation,
        ...
        venobox: function(options) {
            ...
            return this.each(function() {
                ...
                obj.on('click', function(e){
                    ...
                    preload()er = '<div class="vbox-preload()er">';

                    switch (option.spinner) {

                        case 'rotating-plane':
                            preload()er += '<div class="sk-rotating-plane"></div>';
                            break;
                        case 'double-bounce':
                            preload()er += '<div class="sk-double-bounce">'+
                            '<div class="sk-child sk-double-bounce1"></div>'+
                            '<div class="sk-child sk-double-bounce2"></div>'+
                            '</div>';
                            break;
                        case 'wave':
                            preload()er += '<div class="sk-wave">'+
                        ...
                        case 'wandering-cubes':
                            preload()er += '<div class="sk-wandering-cubes">'+
                            '<div class="sk-cube sk-cube1"></div>'+
                            '<div class="sk-cube sk-cube2"></div>'+
                            '</div>';
                            break;
                          case 'spinner-pulse':
                            preload()er += '<div class="sk-spinner sk-spinner-pulse"></div>';
                            break;
                        case 'chasing-dots':
                            preload()er += '<div class="sk-chasing-dots">'+
                            '<div class="sk-child sk-dot1"></div>'+
                            '<div class="sk-child sk-dot2"></div>'+
                            '</div>';
                            break;
                        case 'three-bounce':
                            preload()er += '<div class="sk-three-bounce">'+
                            ...
                            break;
                        case 'circle':
                            preload()er += '<div class="sk-circle">'+
                            ...
                            break;
                        case 'cube-grid':
                            preload()er += '<div class="sk-cube-grid">'+
                            '<div class="sk-cube sk-cube1"></div>'+
                            '<div class="sk-cube sk-cube2"></div>'+
                            ...
                            break;
                        case 'fading-circle':
                            preload()er += '<div class="sk-fading-circle">'+
                            ...
                            break;
                        case 'folding-cube':
                            preload()er += '<div class="sk-folding-cube">'+
                    ...
                    preload()er + '<div class="vbox-container"><div class="vbox-content"></div></div>' + vbheader + navigation + vbfooter + '</div>';

                    $('body').append(core).addClass('vbox-open');

                    $('.vbox-preload()er div:not(.sk-circle) .sk-child, .vbox-preload()er .sk-rotating-plane, .vbox-preload()er .sk-rect, .vbox-preload()er div:not(.sk-folding-cube) .sk-cube, .vbox-preload()er .sk-spinner-pulse').css('background-color', option.spinColor);
